...
class VindiciaTestCase(VindiciaTest):
    ...
    #
    #     self.assertEqual(auth['version'], self.app_settings.VIN_SOAP_CLIENT_VERSION)
    #     self.assertEqual(auth['login'], self.app_settings.VIN_SOAP_CLIENT_USER)
    #     self.assertEqual(auth['password'], self.app_settings.VIN_SOAP_CLIENT_PASSWORD)
    #
    ...
    #     version = self.settings.VIN_SOAP_CLIENT_VERSION
    #
    ...
    #         merchantAccountId=self.user.id,
    #         emailAddress=self.user.email,
    #         preferredLanguage=self.user.extended.lang,
